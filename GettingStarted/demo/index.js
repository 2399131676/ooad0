...
function showProblemDiagram()
{
	...
	joint.ui.FlashMessage.open('succeed in problem!','',{type:'alert',closeAnimation:{delay:3000}});
	return;
}
...
function showContextDiagram(){
	...
	joint.ui.FlashMessage.open('succeed in context!','',{type:'alert',closeAnimation:{delay:3000}});
	return;
}
